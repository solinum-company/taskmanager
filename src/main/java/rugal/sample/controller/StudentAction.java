...
public class StudentAction {
	...
	private static final Logger LOG = LoggerFactory
			.getLogger(StudentAction.class.getName());
	...
	public Message updateStudentProfile(@PathVariable("id") String id,
			@RequestBody Student bean) {
		 ...
		 */
		return Message.successMessage(CommonMessageContent.PROFILE_UPDATED,
				bean);
	}
	...
	public Message deregister(@PathVariable("id") String id) {
		...
		return Message.successMessage(CommonMessageContent.STUDENT_DELETED,
				bean);
	}
	...
	public Message retrieve(@PathVariable("id") String id) {
		LOG.info("call get student by id  : {}", id);
		Student bean = studentRepository.findOne(new ObjectId(id));
		LOG.info("get student bean by ID result  : {}", bean);
